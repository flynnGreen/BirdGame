...
#define WINDOW_TITLE "Learning to Fly"
...
#define DEBUG_DRAW_CAMERA_POSITION 0

#define DEBUG_DRAW_SPRITE_RECT 0
#define DEBUG_DRAW_SPRITE_AABB 0

#define DEBUG_DRAW_COLLIDERS 0
#define DEBUG_DRAW_DYNAMIC_COLLIDERS_INFO 0
#define DEBUG_DRAW_STATIC_COLLIDERS_INFO 0
